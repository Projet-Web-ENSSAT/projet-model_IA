...
const Venus = ({ scale = 0.0045, orbitRadius = 6, orbitSpeed = 0.3, paused, onPlanetClick }) => {
  const venusRef = useRef();
  const fbx = useFBX("/src/assets/model/venus/source/Venus.fbx");
  const texture = useTexture("/src/assets/model/venus/textures/8k_venus_surface.jpg");
